...
@Slf4j
@Component
public class JobManager implements ApplicationContextAware, CommandLineRunner, ConfigApplier {
    ...
    public Collection<ConfigKey> keys() {
        return ConfigKey.of(com.haruhi.botserver.configuration.metadata.ConfigFile.JOB);
    }

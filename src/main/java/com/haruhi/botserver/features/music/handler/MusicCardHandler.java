package com.haruhi.botserver.features.music.handler;

import com.haruhi.botserver.bot.handler.IAllMessageHandler;

import com.haruhi.botserver.infrastructure.cache.CacheMap;
...
import com.haruhi.botserver.features.music.client.model.music163.Song;
...
import com.haruhi.botserver.features.music.service.AbstractMusicService;
import com.haruhi.botserver.features.music.service.MusicServiceFactory;
...
@Component
@Slf4j
public class MusicCardHandler implements IAllMessageHandler {
